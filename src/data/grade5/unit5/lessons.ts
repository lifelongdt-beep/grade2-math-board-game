...
export const unit5Lesson3: G5Family[] = [
  ...
  },
  {
    ...
    make: (seed) => {
      const 하나 = [
        {
          // '계속 늘여도 만나지 않는 두 면을 무엇이라고 할까요'라고 물으면
          // '서로 평행하다'가 먼저 떠오릅니다. 그것이 지도서의 말이기도
          // 합니다. 밑면을 물으려면 평행하다는 것을 이미 말해 주고 물어야
          // 답이 하나로 정해집니다.
          q: '직육면체에서 서로 평행한 두 면을 무엇이라고 할까요?',
          a: '밑면',
          w: ['옆면', '모서리', '꼭짓점'],
          why: '계속 늘여도 만나지 않는 두 면을 서로 평행하다고 하고, 직육면체에서 서로 평행한 두 면을 밑면이라고 합니다.',
        },
        {
          q: '직육면체에서 밑면과 수직인 면을 무엇이라고 할까요?',
          a: '옆면',
          // '겨냥도'는 5차시에서 처음 배웁니다. 3차시 보기에 두면
          // 아이가 모르는 말을 고르게 됩니다.
          w: ['밑면', '모서리', '꼭짓점'],
