...
export const lesson1Middle: G5Family[] = [
  ...
  },
  {
    ...
    make: (seed) => {
      const 장면 = pick([
        { 글: '놀이기구 앞에 "키 130 cm 이상 탑승 가능"이라고 쓰여 있습니다.', 답: '수의 범위를 나타낸 것입니다.' },
      ...
      return {
        ...
        hint: "'이상', '이하'처럼 경계를 말하는지, '약'처럼 대략을 말하는지 살펴보세요.",
        steps: [
          장면.답 === '수의 범위를 나타낸 것입니다.'
            ? "'이상', '최대'처럼 어디까지인지를 말하고 있으므로 수의 범위입니다."
