...
export type Template = {
  ...
  // 중 수준 전용 문장제입니다.
  //
  // 중의 서른 자리 가운데 열아홉이 하와 똑같은 모양이 나오는 차시가
  // 있었습니다. 둘 다 같은 생성기가 채우고 있었기 때문입니다. 중이
  // 먼저 가져갈 자리를 만들어, 그 차시가 요구하는 개념을 상황에 붙여
  // 묻는 문항을 넣습니다.
  mid?: boolean;

  // 실생활 문제 해결 문항입니다. 상 수준의 자리 가운데 얼마를 이런
  // 문항에 내주려면, 문제은행 전체가 아니라 이것만 골라 쓸 수 있어야
  // 합니다. 상 자리 스무 곳이 모두 '과정 짚기'와 '옳은 것 고르기'로
  // 차 있어, 문항을 아무리 더 써도 화면에 나오지 않았습니다.
  real?: boolean;
