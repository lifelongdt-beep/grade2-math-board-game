...
//
// 이렇게 수를 좁혀 두어도 괜찮은지 선생님께 여쭈었고, 괜찮다는 답을
// 받았습니다(2026-09). 치르는 값은 비스듬한 변이 늘 5, 10, 13, 15, 17
// 가운데 하나로 나온다는 것입니다. 눈 밝은 아이는 알아챌 수 있습니다.
// 그래도 이 값은 답을 고르는 데 쓰이지 않습니다. 넓이는 어디서나
// 밑변과 높이로만 구하고(아래 치수만들기 참고), 비스듬한 변은 '높이
// 대신 이것을 쓰면 안 된다'는 것을 보여 주려고 그려 둔 미끼입니다.
// 그 수가 우연히 답처럼 보이는 수와 같아지는 것은 흘리는수인가가
// 따로 막습니다. 그러니 되풀이된다고 해서 답이 새지는 않습니다.
//
// 이 목록을 늘리려면 피타고라스 수를 더 넣으면 됩니다(예: [20, 21, 29]).
// 목록에 없는 아무 수나 넣으면 그림과 적힌 수가 어긋납니다.
