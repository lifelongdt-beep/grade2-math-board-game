...
const isStepSlot = (difficulty: Difficulty, index: number) => {
  ...
  // "안내된 절차에 따라 두 자리 수의 범위에서 간단한 덧셈과 뺄셈을
  // 할 수 있다"입니다. 그런데 우리는 하에 단계를 보여 주는 문항을
  // 한 자리도 두지 않고, 오히려 상에 스무 자리를 두었습니다.
  // 단계를 보여 주는 것은 어렵게 만드는 장치가 아니라 도와주는
  // 장치이므로, 가장 도움이 필요한 수준에 없는 것이 뒤집힌 것입니다.
