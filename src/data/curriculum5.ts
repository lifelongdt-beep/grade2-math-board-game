  ...
  unit(5, '직육면체와 정육면체', [
    {
      title: '단원 도입',
      objective: '이전에 배운 내용을 확인하고 이 단원에서 배울 내용을 확인한다.',
      achievement: '[6수03-03] 직육면체와 정육면체를 이해하고, 구성 요소와 성질을 탐구하고 설명할 수 있다.',
      tags: ['shape', 'solid'],
      textbookFocus: '직사각형, 정사각형, 수직, 평행을 떠올리고 생활 속 상자 모양을 살펴본다.',
      workbookFocus: '앞서 배운 평면도형의 뜻과 두 직선의 관계를 다시 확인한다.',
    },
    {
      title: '직육면체는 무엇일까요',
      objective: '직육면체를 이해하고 구성 요소를 안다.',
      achievement: '[6수03-03] 직육면체를 이해하고, 구성 요소를 탐구하고 설명할 수 있다.',
      tags: ['solid'],
      textbookFocus: '여러 가지 도형을 모든 면이 직사각형인 것과 아닌 것으로 분류한다.',
      workbookFocus: '면, 모서리, 꼭짓점을 찾고 그 수를 빠뜨리지 않고 센다.',
    },
    {
      title: '직육면체에는 어떤 성질이 있을까요',
      objective: '직육면체에서 면 사이의 관계를 알고 서로 평행한 면과 수직인 면을 찾을 수 있다.',
      achievement: '[6수03-03] 직육면체의 성질을 탐구하고 설명할 수 있다.',
      tags: ['solid'],
      textbookFocus: '마주 보는 두 면이 평행함을 확인하고 그 두 면을 밑면이라고 한다.',
      workbookFocus: '주어진 면과 평행한 면 1개와 수직인 면 4개를 모두 찾는다.',
    },
    {
      title: '정육면체는 무엇일까요',
      objective: '정육면체를 이해하고 구성 요소를 안다.',
      achievement: '[6수03-03] 정육면체를 이해하고, 구성 요소를 탐구하고 설명할 수 있다.',
      tags: ['solid'],
      textbookFocus: '직육면체를 모든 면이 정사각형인 것과 아닌 것으로 분류한다.',
      workbookFocus: '정육면체와 직육면체의 같은 점과 다른 점을 말한다.',
    },
    {
      title: '직육면체의 겨냥도는 무엇일까요',
      objective: '직육면체의 겨냥도를 이해하고 겨냥도를 바르게 그릴 수 있다.',
      achievement: '[6수03-04] 직육면체와 정육면체의 겨냥도와 전개도를 그릴 수 있다.',
      tags: ['solid'],
      textbookFocus: '보이는 모서리는 실선으로, 보이지 않는 모서리는 점선으로 그린다.',
      workbookFocus: '보이는 면 3개, 모서리 9개, 꼭짓점 7개를 세어 확인한다.',
    },
    {
      title: '직육면체의 전개도는 무엇일까요',
      objective: '직육면체의 전개도를 이해하고 여러 가지 방법으로 그릴 수 있다.',
      achievement: '[6수03-04] 직육면체와 정육면체의 겨냥도와 전개도를 그릴 수 있다.',
      tags: ['solid'],
      textbookFocus: '상자를 모서리를 따라 잘라 펼쳐 보고, 접었을 때 만나는 점과 겹치는 선분을 찾는다.',
      workbookFocus: '전개도가 될 수 있는 것과 될 수 없는 것을 가리고 그 까닭을 말한다.',
    },
    {
      title: '정육면체의 전개도는 무엇일까요',
      objective: '정육면체의 전개도를 이해하고 여러 가지 방법으로 그릴 수 있다.',
      achievement: '[6수03-04] 직육면체와 정육면체의 겨냥도와 전개도를 그릴 수 있다.',
      tags: ['solid'],
      textbookFocus: '정육면체의 전개도를 살펴보고 접었을 때 만나는 점을 찾는다.',
      workbookFocus: '정사각형을 옮겨 정육면체의 전개도가 되는 자리를 찾는다.',
    },
  ]),
  unit(6, '평균과 가능성', [
    {
      title: '단원 도입',
      objective: '이전에 배운 내용을 확인하고 이 단원에서 배울 내용을 확인한다.',
      achievement: '[6수04-02] 평균의 의미를 알고 주어진 자료의 평균을 구할 수 있으며, 이를 문제 해결에 활용할 수 있다.',
      tags: ['data', 'average'],
      textbookFocus: '앞서 배운 그림그래프·막대그래프·꺾은선그래프를 떠올리고, 평균이 필요한 상황을 살펴본다.',
      workbookFocus: '표를 읽어 값을 찾고 모두 더해 본다.',
    },
    {
      title: '평균은 무엇일까요',
      objective: '평균의 의미를 이해한다.',
      achievement: '[6수04-02] 평균의 의미를 알고 주어진 자료의 평균을 구할 수 있다.',
      tags: ['average'],
      textbookFocus: '자료의 값을 고르게 하는 활동으로 대표하는 값의 뜻을 찾는다.',
      workbookFocus: '평균이 가장 작은 값과 가장 큰 값 사이에 있음을 확인한다.',
    },
    {
      title: '평균을 어떻게 구할까요',
      objective: '평균을 구하는 방법을 이해하고 평균을 구할 수 있다.',
      achievement: '[6수04-02] 주어진 자료의 평균을 구할 수 있다.',
      tags: ['average'],
      textbookFocus: '(자료 값의 합)÷(자료의 수)로 평균을 구한다.',
      workbookFocus: '평균에서 자료 값의 합과 자료의 수를 거꾸로 구해 본다.',
    },
    {
      title: '평균을 어떻게 해석할까요',
      objective: '자료를 수집하여 평균을 구하고 해석할 수 있다.',
      achievement: '[6수04-02] 평균을 문제 해결에 활용할 수 있다.',
      tags: ['average'],
      textbookFocus: '사람 수가 다른 두 모둠의 평균을 견주고, 평균을 이용해 빠진 값을 구한다.',
      workbookFocus: '0인 자료를 빠뜨리지 않고 세며, 평균을 잘못 해석한 말을 가린다.',
    },
    {
      title: '일이 일어날 가능성을 어떻게 말로 표현할까요',
      objective: '일이 일어날 가능성을 말로 표현할 수 있다.',
      achievement: '[6수04-03] 사건이 일어날 가능성을 수나 말로 나타낼 수 있다.',
      tags: ['possibility'],
      textbookFocus: '불가능하다, ~아닐 것 같다, 반반이다, ~일 것 같다, 확실하다로 표현한다.',
      workbookFocus: '회전판과 주머니를 보고 알맞은 말을 고른다.',
    },
    {
      title: '일이 일어날 가능성을 어떻게 비교할까요',
      objective: '실생활 상황에서 일이 일어날 가능성을 이해하고 비교할 수 있다.',
      achievement: '[6수04-03] 사건이 일어날 가능성을 비교할 수 있다.',
      tags: ['possibility'],
      textbookFocus: '가능성을 먼저 말로 표현한 다음 높은 순서대로 견준다.',
      workbookFocus: '회전판과 주머니를 견주어 가능성이 가장 높은 것과 낮은 것을 찾는다.',
    },
    {
      title: '일이 일어날 가능성을 어떻게 수로 나타낼까요',
      objective: '일이 일어날 가능성을 수로 나타낼 수 있다.',
      achievement: '[6수04-03] 사건이 일어날 가능성을 수로 나타낼 수 있다.',
      tags: ['possibility'],
      textbookFocus: '불가능하다는 0, 반반이다는 1/2, 확실하다는 1로 나타낸다.',
      workbookFocus: '말로 먼저 표현한 다음 수로 옮긴다.',
    },
    {
      title: '가능성을 바탕으로 어떻게 적절한 판단을 할까요',
      objective: '실험 결과를 보고 일이 일어날 가능성을 예상하여 적절한 판단을 할 수 있다.',
      achievement: '[6수04-03] 사건이 일어날 가능성을 바탕으로 판단할 수 있다.',
      tags: ['possibility'],
      textbookFocus: '실험 결과를 나타낸 표를 보고 어떤 회전판인지 예상한다.',
      workbookFocus: '가능성이 가장 높은 색과 낮은 색을 찾아 판단한다.',
    },
  ]),
];
